            ...
            <section className='relative footer-bg mt-10 flex  flex-col-reverse items-center sm:flex-row sm:flex-wrap sm:items-start justify-evenly pt-10 pb-28 md:px-5 lg:py-22 lg:pt-10  lg:px-10 gap-14 sm:gap-5 xl:gap-0'>
              ...
              text-[14px] gap-3 md:gap-5'>
                 ...
                 <div className=' flex flex-col items-center justify-center sm:items-start sm:justify-start sm:w-[230px]  lg:w-[229px]'>
                    <p className='text-[18px] font-bold mb-2 md:mb-10 '>Main Branch Offices</p>
              ...
              text-[14px] gap-3 sm:gap-4'>
                ...
                <div className=' flex flex-col items-center justify-center sm:w-[290px] md:w-full md:px-10 xl:w-[449px] md:mt-6 xl:mt-0'>
                    ...
                    <p className='text-[14px] xl:w-[494px] mb-2 text-center xl:text-start px-4 sm:px-0 sm:text-start md:text-center xl:px-0'>All trademarks and logos or registered trademarks and logos found on this Site or mentioned herein belong to their respective owners and are solely being used for informational purposes.</p>
                    <div className=' flex flex-col md:flex-row items-center justify-center gap-4 md:gap-0'>
                        <input className='rounded-[8px] md:rounded-none px-6 md:w-[325px] md:h-[40px]
                        h-[30px] w-[300px] text-[14px] bg-white' type="email" placeholder='your email' />
                        <button className='bg-black text-white text-[16px] px-[30px] md:px-[30px] py-1 md:py-2 rounded-[8px] md:rounded-none'>Subscribe</button>
                    </div>
                </div>
                  ...
                  {/* folow */}
                    <div className='flex items-center justify-center text-[20px]  gap-4'>
                        ...
                        <div className='flex items-center justify-center gap-6 md:gap-4'>
                            <AiFillInstagram className='sm:text-[20px]'></AiFillInstagram>
                            <AiFillLinkedin className='sm:text-[20px]'></AiFillLinkedin>
                            <AiFillFacebook className='sm:text-[20px]'></AiFillFacebook>
                            <AiOutlineTwitter className='sm:text-[20px]'></AiOutlineTwitter>
                        </div>
                    </div>
                    {/* copyright */}
                    <p className='text-[14px] text-center'>Agile Global 2021-2022 - All rights reserved</p>
                  </div>
                 </div>
            </section>
        </>
