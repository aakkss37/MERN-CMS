...
const Navbar = () => {
	...
	return (
		<>
			...
			{
				ShowMobileNavDiv &&
				<div ref={oneRef} className='home-nav-desk-animation-links z-10 mobile-nav-drop-shadow absolute top-[65px]  w-full bg-white '>
					<ul >
						<li onClick={(prev) => setShowHomeMenuLinks((prev) => !prev)} className='flex items-center justify-center text-[18px] sm:text-[20px] p-2'>Home <MdOutlineKeyboardArrowDown></MdOutlineKeyboardArrowDown></li>
						{
							showHomeMenuLinks &&
							<div>
								<ul className='text-[16px] sm:text-[18px]'>
					...
					<ul>
						<li onClick={(prev) => setShowSolutionMenuLinks((prev) => !prev)} className='flex items-center justify-center text-[18px] sm:text-[20px] p-2'>Solutions <MdOutlineKeyboardArrowDown></MdOutlineKeyboardArrowDown></li>
						{
					...
					<ul>
						<li onClick={handleCrossIcon} className='flex items-center justify-center text-[18px] sm:text-[20px] p-2'><Link to='/partner'>Partner Model</Link> </li>
						<li onClick={handleCrossIcon} className='flex items-center justify-center text-[18px] sm:text-[20px] p-2'><Link to='/career'>Careers</Link> </li>
						<li onClick={handleCrossIcon} className='flex items-center justify-center text-[18px] sm:text-[20px] p-2'> <Link to='/contact'>Contact Us</Link> </li>
						<li onClick={handleCrossIcon} className='flex items-center justify-center text-[18px] sm:text-[20px] p-2'>
							{/* search and language div */}
