          ...
          {[1].map((elem) => (
            <div className="text-start flex items-center md:items-start flex-col justify-center gap-6">
              ...
              <p className="text-[24px] leading-[30px] text-center md:text-start">
                ...
                over-deliver coupled with incorporating lessons-learnt to offer
                best of breed solutions with the customer’s best interest in
                mind, has been the recipe for success to both our clients and
                workforce.
              </p>
            </div>
          ))}
